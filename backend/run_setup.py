...
def run_setup():
    ...
    # Verify
    cursor.execute("SELECT 'SALES_DATA' as t, COUNT(*) as c FROM SALES_DATA UNION ALL SELECT 'CUSTOMER_FEEDBACK', COUNT(*) FROM CUSTOMER_FEEDBACK UNION ALL SELECT 'SUPPORT_TICKETS', COUNT(*) FROM SUPPORT_TICKETS")
    print("\n📊 Tables created:")
